...
<div class="row">
	<div class="col-md-2">
		<a href="index.php?pagina=clientes" type="button" class="btn btn-primary"><span class="fa fa-plus"></span> Nova Cobrança</a>
	</div>
	<form method="POST" action="rel/cobrancas_class.php" target="_blank">
	<div class="col-md-2">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
					...
					<div class="row">
						<div class="col-md-4">							
								<label>Valor</label>
								<input type="text" class="form-control" id="valor_baixar" name="valor_baixar" placeholder="Valor" readonly="" onkeyup="mascara_valor('valor_baixar')">							
						</div>						
